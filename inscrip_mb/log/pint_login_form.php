...
if ($inscHabilitada){
	...
	print <<<x001
		<font style="font-family:arial; font-size:16px; color:red;">
		Disculpe el proceso est&aacute; deshabilitado.
		</font>
x001
;
}
...
carnet estudiantil ORIGINAL. No se aceptan fotocopias. </li>
