...
<input type="hidden" name="codigo_pquia" value="<?php echo $codigo_pquia; ?>">
<input type="hidden" name="codigoe_S_1" value="<?php echo $estado; ?>">

<select name="codigo_mS" id="codigom_S_1" class="datospf" onChange="parroquia_plantel2(codigoe_S_1.value,this.value); validar(this);">
