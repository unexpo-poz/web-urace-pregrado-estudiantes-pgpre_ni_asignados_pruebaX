<?php
$enProduccion		= true;
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/pgpre_ni_asignados_prueba/';
...
//$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/nuevo_ingreso/carga-datos_'.$lapsoProceso.'_fase_E.log';
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log'.$lapsoProceso.'_fase_prueba.log';
$inscHabilitada		= true;
