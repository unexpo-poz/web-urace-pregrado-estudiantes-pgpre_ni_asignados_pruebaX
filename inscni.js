function prepdata() {
	with(document.datos_p) {
		...
		codigo_pquia.value = document.getElementById('codigo_pquia_S_1').value;//Parroquia del plantel
		...
		//document.getElementById('estadoH').value = estadoS.value;
		//estadoH.value = estadoS.value;
		
		if (estadoS.value != '') {
			
            //ciudad.value = ciudadS.value; //ciudad residencia
			ciudad.value = document.getElementById('ciudad_S_1').value; //ciudad residencia
			tot_hab_n.value = document.getElementById('tot_hab_n_S_1').value;//Municipio residencia
		    edo_nac_e.value = document.getElementById('edo_nac_e_S_1').value;//Parroquia resisdencia
        }
...
function reiniciarTodo() {
	with (document.datos_p) {
		...
		if (p_nac_eS.value == '232'){//si pais de nacimiento es venezuela
			...
			document.getElementById("span_municipio_nac").style.display = "block";
			document.getElementById("span_parroquia_nac").style.display = "block";
			
			document.getElementById("lnace_S_1").style.display = "block";
			document.getElementById("entfed_S_1").style.display = "block";
			document.getElementById("depend_p_e_S_1").style.display = "block";
			document.getElementById("tot_raz_v_S_1").style.display = "block";

			ent_fedS.value = ent_fed.value;
			lnace_S_1.value = l_nac_e.value;
			depend_p_eS.value = depend_p_e.value;
			tot_raz_vS.value = tot_raz_v.value;
		...
		if (codigo_pS.value == '232'){
			...
			document.getElementById("codigom_S_1").style.display = "block";
			...
			codigo_pquiaS.value = codigo_pquia.value;
		...
		//estado ubicacion residencia
		//estadoS.value = estado.value;
		//alert(estadoS.value);
		if (estadoS != ''){
			//document.getElementById("span_edo_res").style.display = "block";
			//document.getElementById("edoEtiqueta_res").style.display = "block";
			document.getElementById("span_ciudad_res").style.display = "block";
			document.getElementById("cdres_Etiqueta").style.display = "block";
			document.getElementById("span_municipio_res").style.display = "block";
			document.getElementById("mpio_Etiqueta_res").style.display = "block";
			//document.getElementById("codigoe_S_1").style.display = "block";
			document.getElementById("span_parroquia_res").style.display = "block";
			document.getElementById("pquia_Etiqueta_res").style.display = "block";
						
			
			//estadoS.value = estado.value;
			ciudadS.value = ciudad.value;
			tot_hab_nS.value = tot_hab_n.value;
			edo_nac_eS.value = edo_nac_e.value;
		}
...
function calcularEdad() {
	...
	with(document) {
		...
		anio = 2000 + parseInt('0'+getElementById('anioN_N_2').value,10);
	}
...
function verificarFecha(f, conMsg){
	with(f){
		...
		var anyo = parseInt ('0'+anioN.value,10) + 2000;
...
function validarF(f){
	...
	//TRAMPA PARA NO LLENAR TODOS LOS CAMPOS
	//totalE = 0;
	...
	function conf_inicial_DACE(){
		...
		function paisnacimiento1() //CUANDO CAMBIA EL SELECT DE LOS PAISES DE NACIMIENTO
		{
			...
			if (paisN == 232){//VENEZUELA
				...
				document.getElementById("span_municipio_nac").style.display = "none";
				document.getElementById("span_parroquia_nac").style.display = "none";
        ...
        function estadoresidencia() //estado de resisdencia
		{
			var estador = document.getElementById("estado_S_1").value;
            //code
			if (estador != '') {
