...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el m&oacute;dulo no esta disponible.<br><br>
		</div><br>
x001
;
}
...
?>
   ...
   <!--  <tr><td> class ="instruc" style="padding-left:10px;padding-top:10px;" ><b>NOTAS:</b>
      <li>La página, estará abierta del 15 al 20 para asistencia de febrero y marzo 2011.    </li>
	</td></tr>*/ -->
	...
	<td class ="instruc" width="15%">&nbsp;</td>
      ...
      <ul style="padding-right:25px;text-align:justify;">
	       <li>La página estará habilitada del 15 al 20 para asistencia de febrero y marzo 2011.    </li>
